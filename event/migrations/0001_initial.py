# Generated by Django 3.2.3 on 2021-06-30 12:10
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Asset_File', models.FileField(max_length=255, upload_to='covers/')),
            ],
        ),
        migrations.CreateModel(
            name='Location',
        ...
        migrations.AddField(
            model_name='asset',
            name='asset_id',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='event.assetfile'),
        ),
    ]
